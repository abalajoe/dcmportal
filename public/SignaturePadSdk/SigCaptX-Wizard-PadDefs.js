...
function screen_Display1(pad, buttonTextSource, accountNo)
{
  ...
  this.infoText.textString = `Please Press Next on the SignaturePad for Customer Signature Capture \n\t \n\t`;
  ...
  this.signingText.textString = "Check Box to Confirm above information" ;
...
function screen_Display3(pad, buttonTextSource)
{
  ...
  this.stepMsg3.textString = "Step 3 of 4";
  ...
  else
  {
    ...
    this.yButtonRow4 = pad.yText + 7*pad.yLSText + (3*this.KeyWidth);
  ...
  // this.enterBelow.textString = "Enter 10 digit phone Number below";
  ...
  this.pin0 = new buttonObject();
  this.pin0.xPos = this.xButtonCol2;
  this.pin0.yPos = this.yButtonRow4;
  this.pin0.buttonSize = pad.ButtonSize;
  this.pin0.width = pad.ButtonWidth;
  this.pin0.buttonBold = pad.TitleBold;
  this.pin0.buttonType = "0";
  this.pin0.buttonText = "0";

  // Set up the "Press NEXT to continue" object
  this.nextToContinue = setupContinueText(pad);
  ...
  this.nextButton = setupNextButton(pad);
  this.cancelButton = setupPreviousButton(pad);
     ///clear Button
   this.clearButton = new buttonObject();
   this.clearButton.xPos = pad.xButtonLeft;
...
// This function sets up the object definitions for the fourth screen in the wizard sequence
function screen_Display4(pad)
{
  // Set up the "Step 2 of 3" text message object
  this.KeyWidth = pad.Width / 10;
  this.stepMsg4 = new textObject();
  this.stepMsg4.xPos = "right";
  this.stepMsg4.yPos = 2;
  this.stepMsg4.textString = "Step 3 of 3";
  this.stepMsg4.fontName = pad.Font;
  this.stepMsg4.fontBold = true;
  this.stepMsg4.fontSize = pad.TextSize;
  this.stepMsg4.fontForeColor = "";
  this.stepMsg4.fontBackColor = "";
  this.stepMsg4.type = "txt";

  // Set up the informational text object
  // this.infoObject = new textObject();
  // this.infoObject.textString = "Amount: 10,000";
  ...
  // Set up the text object for the "Enter a 4 digit PIN..." prompt
  this.IdNo = new textObject();
  this.IdNo.xPos = "centre";
  this.IdNo.yPos = pad.yText;
  this.IdNo.textString = "Enter ID Number below";
  this.IdNo.fontBold = pad.TitleBold;
  this.IdNo.fontSize = pad.TextSize;
  this.IdNo.type = "txt";
  this.IdNo.fontForeColor = padColors.BLUE;
  this.IdNo.fontBackColor = padColors.WHITE;
...
{
  // Set up the "Step 2 of 2" text message object
  ...
  if (pad.Range == padRange.STU5X0)
  {
    ...
    this.stepMsg2.fontBackColor = padColors.WHITE;
  }
  else
  {
  ...
  if (pad.Range == padRange.STU300)
  {
     this.step1Rectangle.x1Pos = 5;
     this.step1Rectangle.y1Pos = 15;
     this.step1Rectangle.x2Pos = pad.Width-5;
     this.step1Rectangle.y2Pos = 15;
     this.step1Rectangle.options = SOLIDLINE;
  }
  else
  {
     this.step1Rectangle.x1Pos = "left";
