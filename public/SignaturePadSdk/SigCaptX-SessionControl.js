...
var wizardEventController =
{
  ...
  {
    console.log('body_onload loaded');
    clearTextBox();
    actionWhenRestarted();
  },
 ...
 function wizardStart(numScreens)
{
  ...
  var accountNo = document.getElementById("accountNoHidden").value;
  ...
  // start_wizard();
  start_wizard(accountNo); // Pass accountNo to the start_wizard function
  ...
  function start_wizard(accountNo)
  {
  ...
  function onWizCtlConstructor(wizCtlV, status)
  {
    if(wgssSignatureSDK.ResponseStatus.OK == status)
    {
      ...
      // Now pass accountNo to the screen definition
      // display_1 = new screen_Display1(pad, buttonTextSource, accountNo);
    }
    else
    {
  ...
  function onGetPadHeight(wizCtlV, padHeight, status)
  {
    ...
    { 
      ...
      var acctNo = document.getElementById("accountNoHidden").value;
      display_1 = new screen_Display1(pad , buttonTextSource , acctNo);
...
{
  console.log('actionWhenRestarted loaded');
  ...
  wgssSignatureSDK = new WacomGSS_SignatureSDK(onDetectRunning, 8080);
