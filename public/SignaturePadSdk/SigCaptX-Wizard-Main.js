...
//     if (wgssSignatureSDK.ResponseStatus.OK == status) {
//       setFont(
//         display_3.stepMsg3.fontName,
//         display_3.stepMsg3.fontSize,
//         display_3.stepMsg3.fontWeight,
//         false,
//         step3_onPutFont
//       );
//     } else {
...
//     if (callbackStatusOK("WizCtl AddText4", status)) {
//       setFont(
//         display_3.enterBelow.fontName,
//         display_3.enterBelow.fontSize,
//         display_3.enterBelow.fontBold,
//         false,
//         onPutFontEnterBelow
//       );
//     }
...
//       if (
//         display_3.enterBelow.fontForeColor != null &&
//         display_3.enterBelow.fontForeColor != ""
//       ) {
//         setFontForeColor(
//           display_3.enterBelow.fontForeColor,
//           step3_onSetFontForeColorEnterBelow
//         );
//       } else {
...
//       // If a foreground colour has been set then we assume a background colour must also be required
//       setFontBackColor(
//         display_3.enterBelow.fontBackColor,
//         step3_onSetFontBackColorEnterBelow
//       );
//     }
//   }
...
//       // If font colour is required do it now
//       if (
//         display_3.pin1.fontForeColor != null &&
//         display_3.pin1.fontForeColor != ""
//       ) {
//         setFontForeColor(
//           display_3.pin1.fontForeColor,
//           step3_onSetFontForeColorPin1
//         );
//       } else {
...
//       // If a foreground colour has been set then we assume a background colour must also be required
//       setFontBackColor(
//         display_3.pin1.fontBackColor,
//         step3_onSetFontBackColorPin1
//       );
//     }
//   }
...
//           setFontForeColor(
//             display_3.cancelButton.fontForeColor,
//             step3_onSetCancelButtonFontForeColor
//           );
//         } else {
...
//         addObjectImage(
//           display_3.cancelButton,
//           step3_onAddCancelButton,
//           buttonSource
//         );
//       }
//     }
...
//       setFontBackColor(
//         display_3.cancelButton.fontBackColor,
//         step3_onSetCancelButtonFontBackColor
//       );
//     }
//   }
...
//       } else {
//         addObjectImage(
//           display_3.nextButton,
//           step3_onAddNextButton,
//           buttonSource
//         );
//       }
//     }
...
function step4() {
  ...
  function step4_onAddTextEnter(wizCtlV, status) {
    if (callbackStatusOK("WizCtl AddText4", status)) {
      setFont(
        display_4.IdNo.fontName,
        display_4.IdNo.fontSize,
        display_4.IdNo.fontBold,
        false,
        onPutFontEnterBelow
      );
    }
  ...
  function onPutFontEnterBelow(wizCtlV, status) {
    if (callbackStatusOK("WizCtl PutFontEnterBelow", status)) {
      // If font colour is required do it now
      if (
        display_4.IdNo.fontForeColor != null &&
        display_4.IdNo.fontForeColor != ""
      ) {
        setFontForeColor(
          display_4.IdNo.fontForeColor,
        ...
        addTextObject(display_4.IdNo, onAddEnterBelow);
      }
    }
  }
  ...
  function step4_onSetFontBackColorEnterBelow(wizCtlV, status) {
    if (callbackStatusOK("WizCtl SetFontBackColorEnterBelow", status)) {
      // After setting up the font colours set up the text string itself
      addTextObject(display_4.IdNo, step4_onAddEnterBelow);
    }
  }
